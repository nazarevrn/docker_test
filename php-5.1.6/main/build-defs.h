...
#define CONFIGURE_COMMAND " './configure' '--with-apxs2=/usr/local/apache2/bin/apxs'"
...
#define PHP_EXTENSION_DIR       "/usr/local/lib/php/extensions/no-debug-non-zts-20050922"
