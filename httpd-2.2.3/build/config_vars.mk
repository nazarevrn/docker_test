...
shared_build =
AP_LIBS = /var/www/httpd-2.2.3/srclib/pcre/libpcre.la /var/www/httpd-2.2.3/srclib/apr-util/libaprutil-1.la /var/www/httpd-2.2.3/srclib/apr-util/xml/expat/lib/libexpat.la /var/www/httpd-2.2.3/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /var/www/httpd-2.2.3
...
EXTRA_CXXFLAGS =
EXTRA_LDFLAGS = -L/var/www/httpd-2.2.3/srclib/apr-util/xml/expat/lib
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/var/www/httpd-2.2.3/srclib/apr/include -I/var/www/httpd-2.2.3/srclib/apr-util/include -I/var/www/httpd-2.2.3/srclib/apr-util/xml/expat/lib -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /var/www/httpd-2.2.3/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC =
...
APR_INCLUDEDIR = /var/www/httpd-2.2.3/srclib/apr/include
APR_VERSION = 1.2.7
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /var/www/httpd-2.2.3/srclib/apr-util/include
APU_VERSION = 1.2.7
